...
public class SynchronousWebHooksImplTest {
  ...
  public void isEnabled_returns_true_if_one_valid_global_webhook() {
    ComponentDto componentDto = componentDbTester.insertPrivateProject();
    webhookDbTester.insert(newWebhookDtoForOrganization(componentDto.getOrganizationUuid()).setName("First").setUrl("http://url1"));
  ...
  public void isEnabled_returns_true_if_one_valid_project_webhook() {
    ...
    webhookDbTester.insert(newWebhookDtoForProject(componentDto.uuid()).setName("First").setUrl("http://url1"));
  ...
  public void send_global_webhooks() {
    ...
    ComponentDto componentDto = componentDbTester.insertPrivateProject();
    webhookDbTester.insert(newWebhookDtoForOrganization(componentDto.getOrganizationUuid()).setName("First").setUrl("http://url1"));
    webhookDbTester.insert(newWebhookDtoForOrganization(componentDto.getOrganizationUuid()).setName("Second").setUrl("http://url2"));
