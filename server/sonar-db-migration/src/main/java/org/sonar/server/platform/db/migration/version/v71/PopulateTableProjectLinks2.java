...
public class PopulateTableProjectLinks2 extends DataChange {
  ...
  public void execute(Context context) throws SQLException {
    ...
    massUpdate.select("SELECT" +
      ...
      " on p2.component_uuid=p.component_uuid " +
      "    and p2.href=p.href" +
    ...
    massUpdate.update("insert into project_links2" +
      " (uuid, component_uuid, link_type, name, href, created_at, updated_at)" +
      " values " +
      " (?, ?, ?, ?, ?, ?, ?)");
    massUpdate.rowPluralName("copy data from table project_links into table project_link2");
