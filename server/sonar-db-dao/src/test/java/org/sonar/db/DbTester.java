...
import org.sonar.db.component.ComponentLinkDbTester;
...
public class DbTester extends AbstractDbTester<TestDb> {
  ...
  private final ComponentLinkDbTester componentLinkTester;
  ...
  public DbTester(System2 system2, @Nullable String schemaPath) {
    ...
    this.componentLinkTester = new ComponentLinkDbTester(this);
  ...
  public ComponentLinkDbTester componentLinks() {
